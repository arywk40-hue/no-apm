...
Key Features:
- Standard USCOD training with baseline model
...
class StandardRunner(BaseRunner):
    """
    Standard USCOD training runner with baseline model.
    ...
    def _build_optimizer(self) -> None:
        """Build optimizer and scheduler for model."""
        try:
            ...
            self.logger.info("Successfully built optimizer and scheduler")
        except Exception as e:
